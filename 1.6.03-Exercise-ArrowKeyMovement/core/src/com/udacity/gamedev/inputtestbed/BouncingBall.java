...
public class BouncingBall {
    ...
    public void update(float delta, Viewport viewport) {
        ...
        if (Gdx.input.isKeyPressed(Keys.LEFT)) velocity.x -= delta * ACCELERATION;

        // TODO: Handle Keys.RIGHT
        if (Gdx.input.isKeyPressed(Keys.RIGHT)) velocity.x += delta * ACCELERATION;

        // TODO: Handle Keys.UP
        if (Gdx.input.isKeyPressed(Keys.UP)) velocity.y += delta * ACCELERATION;


        // TODO: Handle Keys.DOWN
        if (Gdx.input.isKeyPressed(Keys.DOWN)) velocity.y -= delta * ACCELERATION;


        // TODO: Use velocity.clamp() to limit the total speed to MAX_SPEED
        velocity.clamp(0.0f, MAX_SPEED);
